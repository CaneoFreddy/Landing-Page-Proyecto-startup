...
export const metrics: MetricItem[] = [
  ...
  { id: 'm2', value: '6-10h/sem', label: 'Horas ahorradas', detail: 'En tareas administrativas y operativas.' },
  { id: 'm3', value: '15-25%', label: 'Menos errores', detail: 'En flujos críticos y validaciones.' },
  { id: 'm4', value: '24-48h', label: 'Respuesta local', detail: 'Equipo en Chile para soporte cercano.' },
];
...
export const projects: ProjectItem[] = [
  {
    ...
    outcome: 'Ahorro promedio de 6 horas semanales en seguimiento y 12% más cumplimiento de metas en 90 días.',
  ...
  },
  {
    ...
    outcome: 'Ahorro de 8 horas semanales en liquidaciones y 15% menos ajustes manuales.',
  ...
  },
  {
    ...
    outcome: '12 horas semanales menos en gestión y 18% menos reclamos vencidos.',
    technologies: ['Angular', 'PostgreSQL', 'Node.js'],
  },
];
...
export const processSteps: ProcessStep[] = [
  {
    ...
    description: 'Identificamos cuellos de botella y oportunidades de optimización.',
  },
  {
    id: 'ps2',
    title: '2. Diseño y mejora',
    description: 'Rediseñamos flujos y construimos el sistema a la medida.',
  },
  {
    id: 'ps3',
    title: '3. Medición y evolución',
    description: 'Medimos eficiencia y optimizamos continuamente.',
  },
];
